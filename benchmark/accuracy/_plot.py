...
def plot_error_distribution_boxplot(benchmark_results: Dict, output_dir = 'benchmark/generated/plots'):
    ...
    g.set(yscale='log')
    g.set_axis_labels("Function Category", "Absolute Error", fontweight='bold', fontsize=13)
    g.figure.suptitle('Error Distribution Across All Samples by Category',
    ...
    g.savefig(f"{output_dir}/error_distribution_boxplot.png",
