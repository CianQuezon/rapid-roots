...
def _benchmark_scipy_brent(
    func_dict: Dict, params: np.ndarray, a_bounds: np.ndarray, b_bounds: np.ndarray
) -> np.ndarray:
...
def _benchmark_scipy_newton(
    func_dict: Dict, params: np.ndarray, x0_values: np.ndarray
) -> np.ndarray:
...
def _benchmark_rapid_roots_brent(
    func_dict: Dict, params: np.ndarray, a_bounds: np.ndarray, b_bounds: np.ndarray
) -> np.ndarray:
...
def _benchmark_rapid_roots_bisect(
    func_dict: Dict, params: np.ndarray, a_bounds: np.ndarray, b_bounds: np.ndarray
) -> np.ndarray:
...
def _benchmark_rapid_roots_newton(
    func_dict: Dict, params: np.ndarray, x0_values: np.ndarray
) -> np.ndarray:
