...
def plot_line_graph_throughput(
    throughput_results: Dict, output_dir="benchmark/generated/plots"
):
    """
    ...
    g.figure.suptitle(
        "Solver Throughput using Lambert W Equation",
        fontweight="bold",
        fontsize=15,
        y=1.02,
    )
    ...
    g.savefig(
        f"{output_dir}/method_throughput_line_plot.png", dpi=300, bbox_inches="tight"
    )
