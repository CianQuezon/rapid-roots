...
from scipy.optimize import brentq, bisect, newton, root_scalar
...
class TestDifferentFunctions:
    ...
    def test_polynomial_scalar_vs_scipy(self, strict_tolerance):
        ...
        scipy_result = root_scalar(polynomial_func, bracket=[-2.0, 2.0], 
                                   method='brentq', xtol=strict_tolerance)
