...
@njit
def parametric_quadratic_prime(x, a):
    """Derivative: 2*a*x"""
    return 2 * a * x
...
class TestGetRootScalarBrent:
    ...
    def test_simple_quadratic_brent(self):
        ...
        root, iters, conv = RootSolvers.get_root(
            func=simple_quadratic, a=0.0, b=5.0, main_solver="brent", use_backup=False
        )
    ...
    def test_simple_quadratic_brent_negative_root(self):
        ...
        root, iters, conv = RootSolvers.get_root(
            func=simple_quadratic, a=-5.0, b=0.0, main_solver="brent", use_backup=False
        )
    ...
    def test_cubic_brent(self):
        ...
        root, iters, conv = RootSolvers.get_root(
            func=cubic, a=0.0, b=5.0, main_solver="brent", use_backup=False
        )
    ...
    def test_exponential_brent(self):
        ...
        root, iters, conv = RootSolvers.get_root(
            func=exponential_func, a=0.0, b=3.0, main_solver="brent", use_backup=False
        )
...
class TestGetRootScalarNewton:
    ...
    def test_transcendental_newton(self):
        ...
        scipy_root = newton(
            transcendental.py_func, 0.5, fprime=transcendental_prime.py_func, tol=1e-10
        )
...
class TestGetRootScalarBisection:
    ...
    def test_cubic_bisection(self):
        ...
        root, iters, conv = RootSolvers.get_root(
            func=cubic, a=0.0, b=5.0, main_solver="bisection", use_backup=False
        )
...
class TestGetRootVectorized:
    ...
    def test_vectorized_brent_same_function(self):
        ...
        roots, iters, conv = RootSolvers.get_root(
            func=simple_quadratic, a=a, b=b, main_solver="brent", use_backup=False
        )
    ...
    def test_vectorized_bisection_same_function(self):
        ...
        roots, iters, conv = RootSolvers.get_root(
            func=simple_quadratic, a=a, b=b, main_solver="bisection", use_backup=False
        )
...
class TestGetRootBackupChain:
    ...
    def test_backup_chain_newton_to_brent_scalar(self):
        ...
        assert_allclose(root, 2.0, rtol=1e-2, err_msg=f"Root {root} not close to 2.0")
    ...
    def test_bracket_solvers_match_scipy(self, solver, scipy_func):
        ...
        for func, a, b, expected in test_functions:
            root, _, conv = RootSolvers.get_root(
                func=func, a=a, b=b, main_solver=solver, tol=1e-10, use_backup=False
            )
